import {
  firebase
} from "./chunk-Y7RBOLF7.js";
import {
  AppCheckInstances
} from "./chunk-KKZPZHAY.js";
import {
  VERSION as VERSION2,
  pendingUntilEvent,
  ɵAngularFireSchedulers
} from "./chunk-KNBYRQX7.js";
import {
  isPlatformServer
} from "./chunk-I22TAJQY.js";
import {
  EnvironmentInjector,
  Inject,
  Injectable,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name2, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-YD5WRF7J.js"))), map(() => ɵfirebaseAppFactory(options, zone, name2)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
